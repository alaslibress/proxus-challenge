import {
  QuizQuestion, TestQuestion, QuizArtifact, TestArtifact, Artifact,
  CreateArtifactInput, QuizAnswer, TestAnswer, AutoQuestionCorrection, QuestionCorrection,
  UngradedQuizAttempt, GradedQuizAttempt, UngradedTestAttempt, GradedTestAttempt,
  ArtifactAttempt, SubmitAttemptInput, ListArtifactsInput
} from "@proxus/shared";
